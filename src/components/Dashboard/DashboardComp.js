...
const DashboardComp = () => {
    ...
    const handleCopyLinkCallback = (fileId) => {
        navigator.clipboard.writeText(API_ENDPOINTS.download + `${fileId}`)
        .then(() => { toast("successfully copied") })
        .catch((error) => toast("Unable to copy"))
    };
    return (
        <div>
            <PrimarySearchAppBar />
            ...
            <div className="flex pt-8 items-center">
                <div className="w-10/12 pl-6 pt-0.5 p-4">
                    <div className="flex justify-between">
                        <h1 className="text-4xl">Uploaded Files</h1>
